...
from train_detectron2_detection.train_detectron2_detection_process import TrainDetectron2DetectionParam
...
# --------------------
class TrainDetectron2DetectionWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainDetectron2DetectionParam()
        else:
...
# --------------------
class TrainDetectron2DetectionWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "train_detectron2_detection"

    def create(self, param):
        # Create widget object
        return TrainDetectron2DetectionWidget(param, None)
